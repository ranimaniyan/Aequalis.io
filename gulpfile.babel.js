...
const webpackConfig = require("./webpack.config.js"),
	...
	paths = {
		...
		images: {
			src: [
				"./src/img/**/*.{webp,jpg,jpeg,png,gif,svg}",
				"!./src/img/svg/*.svg",
				"!./src/img/favicon.{ico,jpg,jpeg,png,gif}"
			],
			dist: "./dist/img/",
			watch: "./src/img/**/*.{webp,jpg,jpeg,png,gif,svg}"
		},
		webp: {
...
// export const smartGrid = cb => {   // not used in current project
...
// export const development = gulp.series(cleanFiles, smartGrid, // smartGrid not used it current project
...
// export const prod = gulp.series(cleanFiles, smartGrid, serverConfig, views, styles, scripts, svgsprites, images, webpimages, fonts, favs); // smartGrid not used it current project
